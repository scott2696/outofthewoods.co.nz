...
Single source of truth for which page owns which terms. build.py runs
audit_keywords() against the rendered HTML, so a Tier 1 term that stops
appearing on its page — or one that starts appearing too often — fails the
build rather than drifting quietly.

RULES ENFORCED
  * every Tier 1 term must appear at least twice on its page
  * every Tier 2 term at least once
  * long-tail terms are targets, not requirements (many are questions we answer
    in our own words); coverage is reported, not enforced
  * no single term may exceed MAX_DENSITY of the page's word count
  * a term must not appear more often on another page than on its owner —
    that is cannibalisation, and it is reported
"""

MAX_DENSITY = 0.012          # 1.2% for any single term
MIN_T1_HITS = 2

PAGES = {

"/online-casinos/": {
 "t1": ["online casinos nz", "best online casino nz", "online casino new zealand",
 ...
 "tail": ["best online casino nz reddit", "which online casino pays out the most nz",
...
"/licensed-online-casinos/": {
 "t1": ["licensed online casinos nz", "legal online casinos nz", "is online gambling legal in nz",
 ...
 "tail": ["which online casinos are licensed in nz", "when do online casinos become legal in nz",
...
"/casino-bonus/": {
 ...
 "tail": ["no wagering casino bonus nz", "low wagering bonus nz", "what does 35x wagering mean",
...
"/no-deposit-bonus/": {
 ...
 "tail": ["100 free spins no deposit nz", "25 free spins no deposit nz", "$5 no deposit bonus nz",
...
"/casino-payout-percentages/": {
 ...
 "tail": ["which online casino has the best payout nz", "average rtp online casino nz",
...
"/fast-payout-casinos/": {
 "t1": ["fast payout casinos nz", "instant withdrawal casino nz", "fastest paying online casino nz",
        "how long do casino withdrawals take nz"],
 ...
 "tail": ["fastest withdrawal method online casino nz",
          ...
          "fast payout casino nz no verification delay", "online casino payout time new zealand",
          "instant withdrawal pokies nz", "casino that pays out instantly nz",
          "how to speed up casino withdrawal"]},

"/casino-payment-methods/": {
 "t1": ["casino payment methods nz", "online casino deposit methods nz", "paysafecard casino nz",
 ...
 "tail": ["can you use paypal at online casinos nz", "best payment method for online casino nz",
...
"/online-pokies/": {
 ...
 "tail": ["best paying pokies nz", "megaways pokies nz", "progressive jackpot pokies nz",
...
"/live-casino/": {
 ...
 "tail": ["best live casino sites new zealand", "live casino minimum bet nz",
...
"/new-casinos-nz/": {
 ...
 "tail": ["new online casinos nz no deposit bonus", "newly licensed online casinos nz",
...
"/crypto-casinos-nz/": {
 ...
 "tail": ["best bitcoin casino nz 2026", "are crypto casinos legal in nz",
...
"/how-we-rate-casinos/": {
 ...
 "tail": ["responsible gambling nz", "gambling helpline nz"]},
}

# Old path -> new path. Emitted as 301s in the host redirect files.
# NB: these keys are the RETIRED urls and must never be rewritten by a path
# migration — they only exist to be redirected away from.
REDIRECTS = {
 "/online-casinos/bonuses/": "/casino-bonus/",
 ...
 "/best-crypto-casinos/": "/crypto-casinos-nz/",
 "/nz-gambling-law/": "/licensed-online-casinos/",
 "/instant-withdrawals/": "/fast-payout-casinos/",
 "/online-casinos/no-deposit/": "/no-deposit-bonus/",
